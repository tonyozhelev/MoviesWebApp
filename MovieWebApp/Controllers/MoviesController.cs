...
using MovieModelsData.Context;
using MovieModelsData.Models;
using PagedList;
...
namespace MovieWebApp.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies/ExportList
        public ActionResult ExportList()
        {
            var movies = db.Movies.ToList();
            string FilePath = Server.MapPath("~");
            System.IO.File.WriteAllText(FilePath + "movies.json", JsonConvert.SerializeObject(movies));
            return View();
        }
